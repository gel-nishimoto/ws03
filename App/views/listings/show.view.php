...
<section class="container mx-auto p-4 mt-4">
    <div class="rounded-lg shadow-md bg-white p-3">
        <div class="flex justify-between items-center">
            <a class="block p-4 text-primary-brand back-to-listings" href="/listings">
...
<section class="container mx-auto p-4">
    <h2 class="text-xl font-semibold mb-4 text-primary-brand">Job Details</h2>
    <div class="rounded-lg shadow-md bg-white p-4">
        <h3 class="text-lg font-semibold mb-2 text-primary-brand">
            Job Requirements
        </h3>
        <p>
            <?= $listing->requirements ?>
        </p>
        <h3 class="text-lg font-semibold mt-4 mb-2 text-primary-brand">Benefits</h3>
